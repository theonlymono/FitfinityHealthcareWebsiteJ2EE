...
<body>
        <div style="margin-top: -100px; margin-left: -100px;" class="navbar-area">
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
    ...
    <section class="contact" style="font-family: 'Poppins', sans-serif;">
        <div class="contact">
...
<div style="margin-top: 30px; border-radius: 30px; color: #E8BD70;" id="slideshow">
    <% while(rs.next()) { %>
        <div style="margin: -10px; border-radius: 20px;" class="slide">
        	<h4 style="color: white; font-family:  'Poppins', sans-serif; margin-bottom: 10px"><%= rs.getString("feedbackText") %><br></h4>
        	<p style="color: white; font-family:  'Poppins', sans-serif;"><%= rs.getString("patientEmail") %><br></p>
            <h4 style="font-size: 30px; font-weight: 900;"><% int rating = Integer.parseInt(rs.getString("rating")); %></h4>
