  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="profile-card">
        ...
        <form id="updatePhoneForm" action="http://localhost:8080/Fitfinity/UpdatePhoneServlet" method="post">
		    <div class="form-group">
		        <!-- Add hidden input field for userid -->
		        <input type="hidden" name="userid" value="<%= userid %>">
		    </div>
        ...
        <!-- Back Button -->
        <a href="./patientDashboard.jsp?userid=<%=userid%>&username=<%= dao.getName(userid) %>"><button class="back-button mt-4" >Back</button></a>
