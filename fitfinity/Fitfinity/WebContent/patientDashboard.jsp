...
<html class="no-js" lang="">
  ...
  if(userid==null){
	  userid=(String)request.getParameter("userid");
  	 ...
  	 String patient = (String) request.getAttribute("userName");
  	 if(patient == null){
  		patient = (String)request.getParameter("username");
  	 }
  %>
    <div class="preloader">
      <div class="loader">
              ...
              <div class="col-md-8">
                <div class="header-top-left text-center text-md-left">
                  <ul>
                    <li>
                      <a href="#"
                        ><i class="lni lni-phone"></i> +959985056890</a
                      >
                    </li>
                    <li>
                      <a href="#"
                        ><i class="lni lni-envelope"></i> fitfinity@gmail.com</a
                      >
                    </li>
                  </ul>
                </div>
              ...
              <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg">
                  <a class="navbar-brand" href="index.html">
                    ...
                    <h6 style="margin-left: 26%; margin-top: -5%" class="navDiv">
                      <span
                  ...
                  >
                    <ul id="nav" class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item mt-3">
                        <a class="" href="./doctors.jsp?PatientID=${userId}&userName=${userName}">Find Doctor</a>
                      </li>
                      <li class="nav-item mt-3">
                        <a target="_blank" class="" href="./BMI.jsp">BMI</a>
                      </li>
                      <li class="nav-item mt-3">
                        <a target="_blank" class="" href="./feedback.jsp">Contact</a>
                      </li>
					  <li class="nav-item mt-3">
                        <a target="_blank" class="" href="./medHistory.jsp?userid=<%=userid%>">Medical History</a>
                      </li>
                      <li class="nav-item mt-1">
			            <div class="dropdown-center me-5">
			              ...
			              <ul class="dropdown-menu">
			                <li><a style="font-size: 17px;" class="dropdown-item" href="./ProfileUpdate.jsp?userid=<%= userid %>&username=<%= patient %>"> <%=patient %> <img style="margin-left: 30px;" class=" rounded-circle" width="50px" src="/image/profile1.jpg" alt=""></a></li>
      ...
      <div class="slider-wrapper">
        ...
        <section class="slider-section">
          <div class="slider-active slick-style">
            <div
              class="single-slider img-bg"
              style="background-image: url('assets/image/slider/slider-1.jpg')"
            >
              <div class="container">
                <div class="row">
                  <div class="col-xl-7 col-lg-8 col-md-10">
                    <div class="slider-content">
                      ...
                      <p
                        ...
                        data-delay=".7s"
                      >
						At Comprehensive Healthcare Solutions, we are dedicated to providing exceptional care and support. Our team of experts is committed to your well-being every step of the way.
                      </p>
                      <a
                        href="#about"
                        class="btn theme-btn page-scroll"
            ...
            <div
              class="single-slider img-bg"
              style="background-image: url('assets/image/slider/slider-2.jpg')"
            >
              <div class="container">
                <div class="row">
                  <div class="col-xl-7 col-lg-8 col-md-10">
                    <div class="slider-content">
                      ...
                      <p
                        ...
                        data-delay=".7s"
                      >
                        Our facility boasts the best doctors and the latest equipment, ensuring that you receive the highest quality care possible. Your health and well-being are our top priorities.
                      </p>
                      <a
                        href="#contact"
                        class="btn theme-btn page-scroll"
            ...
            <div
              class="single-slider img-bg"
              style="background-image: url('assets/image/slider/slider-3.jpg')"
            >
              <div class="container">
                <div class="row">
                  <div class="col-xl-7 col-lg-8 col-md-10">
                    <div class="slider-content">
                      ...
                      <p
                        ...
                        data-delay=".7s"
                      >
                        We prioritize your health above all else. Our dedicated team works tirelessly to ensure that you receive personalized care and attention tailored to your unique needs.
                      </p>
                      <a
                        href="#services"
                        class="btn theme-btn page-scroll"
    ...
    <section class="we-do-section pt-150">
      <div class="shape shape-1">
        <img src="assets/image/shapes/shape-1.svg" alt="" />
      </div>
      <div class="container">
        <div class="row">
          <div class="col-xl-8 mx-auto">
            <div class="section-title text-center mb-55">
              ...
              <p class="wow fadeInUp" data-wow-delay=".6s">
                "We provide personalized healthcare with skilled professionals, advanced technology, and patient empowerment. Our goal is your optimal health and a brighter future through accurate diagnoses and effective treatments."
        ...
        <div class="row">
          <div class="col-xl-12">
            <div class="graph mb-60">
              <img src="assets/image/we-do/graph-img.svg" alt="" />
            </div>
          </div>
          <div class="col-lg-3">
    ...
    <section id="about" class="about-section pt-120">
      <div class="shape shape-2">
        <img src="assets/image/shapes/shape-2.svg" alt="" />
      </div>
      <div class="container">
        <div class="row">
          <div class="col-xl-10 col-lg-11 mx-auto">
            <div class="about-content text-center mb-55">
              ...
              <p class="mb-35 wow fadeInUp" data-wow-delay=".6s">
                Welcome to Our Clinic. We strive to provide exceptional care tailored to your needs. Our team of dedicated professionals utilizes advanced techniques to ensure your well-being. Trust us for comprehensive healthcare solutions that prioritize your health and comfort.
              </p>
              <a
                href="#"
                class="btn theme-btn wow fadeInUp"
                data-wow-delay=".8s"
                >Learn More</a
              >
            </div>
      ...
      <div class="about-img text-center">
        <img src="assets/image/about/about-img.png" alt="" />
      </div>
    </section>
    <!-- ========================= about-section end ========================= -->
    ...
    <section id="services" class="service-section pt-150">
      <div class="shape shape-3">
        <img src="assets/image/shapes/shape-3.svg" alt="" />
      </div>
      <div class="container">
        <div class="row">
          <div class="col-xl-8 mx-auto">
            <div class="section-title text-center mb-55">
              ...
              <p class="wow fadeInUp" data-wow-delay=".6s">
                Our Healthcare Services. We offer a wide range of medical solutions tailored to your needs. Our experienced team utilizes cutting-edge technology to ensure effective care. Trust us for compassionate and comprehensive healthcare that prioritizes your well-being and comfort.
                <br class="d-none d-lg-block" />
              </p>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="service-item mb-30">
              ...
              <div class="service-content">
                <h4>Cardiology</h4>
                <p>
                  Our cardiology department provides expert care for heart-related conditions. From diagnosis to treatment, our skilled team is dedicated to your cardiovascular health
                </p>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item mb-30">
              ...
              <div class="service-content">
                <h4>Neurology</h4>
                <p>
                  Our neurology specialists offer advanced care for disorders of the nervous system. Trust us for comprehensive evaluations and personalized treatment plans.
                </p>
                <a href="#" class="read-more"
                  >Read More <i class="lni lni-arrow-right"></i
                ></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item mb-30">
              ...
              <div class="service-content">
                ...
                <p>
                  Our gastroenterology services address digestive system issues with precision and expertise. We focus on diagnosis, management, and prevention to promote gastrointestinal health.
                </p>
                <a href="#" class="read-more"
                  >Read More <i class="lni lni-arrow-right"></i
                ></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item mb-30">
              ...
              <div class="service-content">
                <h4>Orthopedics</h4>
                <p>
                  Our orthopedic specialists deliver top-notch care for musculoskeletal conditions. Count on us for innovative treatments and compassionate support throughout your recovery journey.
                </p>
                <a href="#" class="read-more"
                  >Read More <i class="lni lni-arrow-right"></i
                ></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item mb-30">
              ...
              <div class="service-content">
                <h4>Gynecology</h4>
                <p>
                  Our gynecology department offers compassionate care for women's health needs. From routine exams to specialized treatments, we prioritize your comfort and well-being.
                </p>
                <a href="#" class="read-more"
                  >Read More <i class="lni lni-arrow-right"></i
                ></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="service-item mb-30">
              <div class="service-icon mb-25">
                <img width="20%" src="./assets/image/service/throat.png" alt="" />
              </div>
              <div class="service-content">
                <h4>Otolaryngology</h4>
                <p>
                  Our otolaryngology experts specialize in treating ear, nose, and throat conditions. Trust us for comprehensive care and personalized treatment plans tailored to your needs.
                </p>
                <a href="#" class="read-more"
                  >Read More <i class="lni lni-arrow-right"></i
                ></a>
    ...
    <section class="faq-section theme-bg">
      <div class="faq-video-wrapper">
        <div class="faq-video">
          <img src="assets/image/faq/faq-img.jpg" alt="" />
        </div>
      </div>
      <div class="shape">
        <img src="assets/image/shapes/shape-8.svg" alt="" class="shape-faq" />
      </div>
      <div class="container">
        <div class="row">
    ...
    <section
      class="subscribe-section pt-100 pb-100 img-bg"
      style="background-image: url(assets/image/bg/subscribe-bg.jpg)"
    >
      <div class="container">
        <div class="row">
          <div class="col-xl-7">
            <div class="section-title">
              ...
              <p class="mb-35">
                ...
                dinonumy <br class="d-none d-lg-block" />
    ...
    <section id="blog" class="blog-section pt-150">
      <div class="shape shape-7">
        <img src="assets/image/shapes/shape-6.svg" alt="" />
      </div>
      <div class="container">
        <div class="row">
          <div class="col-xl-8 mx-auto">
        ...
        <div class="row">
          <div class="col-xl-4 col-lg-4 col-md-6">
            <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".2s">
              <div class="blog-img">
                <a href="#"><img src="assets/image/blog/blog-1.png" alt="" /></a>
              </div>
              <div class="blog-content">
                <h4><a href="#">250+ Medical Tips We Just Had to Share</a></h4>
                <p>
                  Lorem ipsum dolor sirtewt amertse consetetur sadipscing elitr,
                  sedqw dinoumy eirmod tempor invidunt sedrsu.
                </p>
          ...
          <div class="col-xl-4 col-lg-4 col-md-6">
            <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".4s">
              <div class="blog-img">
                <a href="#"><img src="assets/image/blog/blog-2.png" alt="" /></a>
              </div>
              <div class="blog-content">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6">
            <div class="single-blog mb-30 wow fadeInUp" data-wow-delay=".6s">
              <div class="blog-img">
                <a href="#"><img src="assets/image/blog/blog-3.png" alt="" /></a>
              </div>
              <div class="blog-content">
                <h4><a href="#">250+ Medical Tips We Just Had to Share</a></h4>
                <p>
